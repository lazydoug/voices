  ...
  return (
    <div>
      ...
      <textarea
        ...
        className={`mt-8 block max-h-52 w-full resize-none border-b py-1 transition-all duration-300 focus:border-b-[3px] focus:border-b-[#ff85dc]/50 focus:pb-[2px] ${error && 'border-b-[#d93025]'} outline-none`}
      ></textarea>
